...
export const mockProjects: Project[] = [
  {
    id: 'proj-1', code: 'PAY', name: 'Payments Platform', description: 'Core payments processing and settlement engine.', status: 'ACTIVE',
    ...
    managerId: 'emp-0002', managerName: 'Priya Raghavan', managerDesignationId: 'des-2', managerDesignationName: 'Senior Project Manager', managerRoleId: 'role-project-manager', managerRoleName: 'Project Manager', managerAllocationPercentage: 30, managerAllocationStartDate: '2024-02-01', managerAllocationEndDate: '2026-12-31',
  ...
  {
    id: 'proj-2', code: 'ONB', name: 'Customer Onboarding', description: 'KYC, document verification and account setup flows.', status: 'ACTIVE',
    ...
    managerId: 'emp-0002', managerName: 'Priya Raghavan', managerDesignationId: 'des-2', managerDesignationName: 'Senior Project Manager', managerRoleId: 'role-project-manager', managerRoleName: 'Project Manager', managerAllocationPercentage: 30, managerAllocationStartDate: '2024-05-15', managerAllocationEndDate: '2026-09-30',
  ...
  {
    id: 'proj-3', code: 'MOB', name: 'Mobile Banking App', description: 'Consumer-facing iOS and Android banking application.', status: 'ACTIVE',
    ...
    managerId: 'emp-0005', managerName: 'Meera Nair', managerDesignationId: 'des-1', managerDesignationName: 'System Administrator', managerRoleId: 'role-project-manager', managerRoleName: 'Project Manager', managerAllocationPercentage: 50, managerAllocationStartDate: '2023-11-01', managerAllocationEndDate: '2026-08-01',
  ...
  {
    id: 'proj-4', code: 'RSK', name: 'Risk & Fraud Engine', description: 'Real-time transaction risk scoring service.', status: 'ON_HOLD',
    ...
    managerId: 'emp-0002', managerName: 'Priya Raghavan', managerDesignationId: 'des-2', managerDesignationName: 'Senior Project Manager', managerRoleId: 'role-project-manager', managerRoleName: 'Project Manager', managerAllocationPercentage: 20, managerAllocationStartDate: '2024-06-01', managerAllocationEndDate: '2026-06-01',
    teamCount: 9, moduleCount: 1, openDefects: 42, createdAt: '2024-05-10T08:00:00Z', updatedAt: '2026-06-02T08:00:00Z',
  },
  {
    id: 'proj-5', code: 'RPT', name: 'Regulatory Reporting', description: 'Automated compliance reporting for regional regulators.', status: 'ACTIVE',
    ...
    managerId: 'emp-0005', managerName: 'Meera Nair', managerDesignationId: 'des-1', managerDesignationName: 'System Administrator', managerRoleId: 'role-project-manager', managerRoleName: 'Project Manager', managerAllocationPercentage: 40, managerAllocationStartDate: '2026-09-01', managerAllocationEndDate: '2027-06-30',
  ...
  {
    id: 'proj-6', code: 'LEG', name: 'Legacy Ledger Migration', description: 'Migration off the mainframe general ledger.', status: 'COMPLETED',
    ...
    managerId: 'emp-0002', managerName: 'Priya Raghavan', managerDesignationId: 'des-2', managerDesignationName: 'Senior Project Manager', managerRoleId: 'role-project-manager', managerRoleName: 'Project Manager', managerAllocationPercentage: 40, managerAllocationStartDate: '2023-01-10', managerAllocationEndDate: '2024-12-20',
